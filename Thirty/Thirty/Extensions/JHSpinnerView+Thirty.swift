...
class THSpinner {
    ...
    class func showSpinnerOnView(_ view: UIView, text: String? = nil, preventUserInteraction: Bool = true) {
        shared.jhSpinner = JHSpinnerView.showOnView(view, spinnerColor: .white, overlay:.custom(CGSize(width: 200, height: 200), 100), overlayColor: UIColor.thPrimaryPurple.withAlphaComponent(0.6), text: text, textColor: .white)
