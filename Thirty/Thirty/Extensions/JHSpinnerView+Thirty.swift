...
class THSpinner {
    ...
    class func showSpinnerOnView(_ view: UIView, text: String? = nil, preventUserInteraction: Bool = true) {
        shared.jhSpinner = JHSpinnerView.showOnView(view, spinnerColor: .thPrimaryPurple, overlay:.custom(CGSize(width: 200, height: 200), 100), overlayColor: UIColor.thSecondaryPurple.withAlphaComponent(0.3), text: text, textColor: .thPrimaryPurple)
